        ...
        self.menuBar = [
            ...
            ('Play', 0,
                [('Hello', 0, self.greeting),
                 ...
                 ('Demos', 0,
                    [('Toplevels', 0,
                        lambda: self.spawn(r'something.py')),
                     ('Frames', 0,
                        lambda: self.spawn(r'something2.py')),
                     ('Images', 0,
                        lambda: self.spawn(r'something3.py')),
                     ('Alarm', 0,
                        lambda: self.spawn(r'something4.py')),
