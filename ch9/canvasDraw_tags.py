...
class CanvasEventsDemo(canvasDraw.CanvasEventsDemo):
    ...
    def create_oval_tagged(self, x1, y1, x2, y2):  # inserts func as layer between original 'onGrow' func
        objectId = self.canvas.create_oval(x1, y1, x2, y2)
        self.canvas.itemconfig(objectId, tag='ovals', fill='blue')  # sets the config of the objectId
        return objectId
